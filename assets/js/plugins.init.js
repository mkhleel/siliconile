/* Template Name: Siliconile - Saas & Software Landing Page Template
   Author: Siliconile
   E-mail: support@siliconile.com
   Created: August 2019
   Version: 4.9.0
...
try {
    if(document.getElementById("days")){
        ...
        var eventCountDown = new Date("November 11, 2024 16:37:52").getTime();
        ...
        var myfunc = setInterval(function () {
            ...
            document.getElementById("days").innerHTML = days + "<p class='count-head'>أيام</p> "
            document.getElementById("hours").innerHTML = hours + "<p class='count-head'>ساعة</p> "
            document.getElementById("mins").innerHTML = minutes + "<p class='count-head'>دقيقة</p> "
            document.getElementById("secs").innerHTML = seconds + "<p class='count-head'>ثانية</p> "
